import { Component, ElementRef, OnInit, ViewChild, ɵɵstylePropInterpolate1 } from '@angular/core';
...
export class ChildComponent implements OnInit
{
  ...
  eventData;
  myStyles={backgroundColor: 'rgb(250,100,0)',
            position: 'fixed',
            left: '1250px',
            top: '370px',
            //zIndex:10
...
// });
    ...
    PlotlyJS.newPlot(this.ele2.nativeElement, data2, layout2,{responsive:'true'});
setTimeout(()=>{PlotlyJS.update(this.ele2.nativeElement,{x:[]})},5000)
  ...
  //range:[-0.01,5.01]}
    ...
    PlotlyJS.newPlot(this.ele5.nativeElement, data3, layout3,{responsive:'true'});
  ...
  createNote(data)
  {
    this.addNote=false;
    console.log(data);
    PlotlyJS.extendTraces(this.ele5.nativeElement, {x:[[data.points[0].x]],
                                                    y: [[1000]]}, [2])
  }
